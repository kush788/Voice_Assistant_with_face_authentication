...
def weather(city):
    ...
    if 'main' in data:
        ...
        speak(
            f"The temperature in {city} is {temperature} degrees Celsius with {weather_description} and {humidity}% humidity.")
    else:
        speak("City not found or weather data not available. Please try again.")
