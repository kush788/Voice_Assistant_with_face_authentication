...
path = 'authentication\\samples' # Path for samples already taken

recognizer = cv2.face.LBPHFaceRecognizer_create() # Local Binary Patterns Histograms
detector = cv2.CascadeClassifier("authentication\\haarcascade_frontalface_default.xml")
...
recognizer.write('authentication\\trainer\\trainer.yml')  # Save the trained model as trainer.yml
